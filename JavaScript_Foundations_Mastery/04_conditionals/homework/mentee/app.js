...
console.log(`--------------Task 1---------------`);
const studentName = "Navjodh Kundan";//student name will not change
let maxScore = 100; //max score might change when ever student score higher than before
const passingScore = 60;//this is the minimum score required to pass and won't be changing in future
let earnedScore = 73;//score might change if got extra credit
let isExtraCredit = false;//can get extra credit
...
//because if grade is 95 and we write 80 first, the code will check with 80 and print 
//Grade B and will exit the if statement which is wrong.
