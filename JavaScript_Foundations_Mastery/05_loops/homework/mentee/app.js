...
console.log("-----------Task 1----------");
const storeName = "QuickShop";//store name dont change
let budget = 100;//budget can change according to situation
let itemLimit = 30;//can increase item limit in future
let discountThreshold = 80;//can increase or decrease in future
let discountRate = 0.1;//can increase or decrease in future
let cartTotal = 0;//will change everytime item is added or removed from cart
let itemsAdded = 0;//will change everytime item is added or removed from cart
let itemsSkipped = 0;//will change everytime item is added or removed from cart
...
console.log(`Items skeeped: ${itemsSkipped}`);
...
for(let i=1;i<=6;i++){
    ...
    if(currentPrice < 15){
        ...
        console.log(`DoublePoints for item ${i}! ${currentPrice*2} pts`);
    } else {
