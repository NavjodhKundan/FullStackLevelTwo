...
console.log("----------Task 1----------");
const className = "JavaScript Fundamentals";//calss name will not change
const passingScore = 60;//this a fix score for passing
let studentNames = [
    "student1", "student2", "student3", "student4", "student5", "student6"
];//students can change in future
let studentScores = [74, 58, 92, 65, 81, 47];//student score can change in future
...
for(let i=0;i<studentScores.length;i++){
    if(studentScores[i] >= 90){
        console.log(`${studentNames[i]}: ${studentScores[i]} - Grade: A`);
    } else if (studentScores[i] >= 80){
        console.log(`${studentNames[i]}: ${studentScores[i]} - Grade: B`);
    }else if (studentScores[i] >= 70){
        console.log(`${studentNames[i]}: ${studentScores[i]} - Grade: C`);
    }else if (studentScores[i] >= 60){
        console.log(`${studentNames[i]}: ${studentScores[i]} - Grade: D`);
    }else{
        console.log(`${studentNames[i]}: ${studentScores[i]} - Grade: F`);
    }
}
...
const nameRemoved = studentNames.shift();
studentScores.shift();
console.log(`Student removed: ${nameRemoved}`);
console.log(`Class size now: ${studentNames.length}`);
...
console.log(`Students passing after adding curved score: ${passingCount}`);